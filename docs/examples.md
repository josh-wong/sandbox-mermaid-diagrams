> **Note:** The following content is originally from [mermaid/packages/mermaid/src/docs/intro/examples.md](https://github.com/mermaid-js/mermaid/blob/develop/packages/mermaid/src/docs/intro/examples.md)
